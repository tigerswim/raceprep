...
import { useConnectStravaMutation } from '../store/api';
                  ...
                  {message.includes('log in to RacePrep') ? (
                    <>
                      <button
                        ...
                        className="w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white px-6 py-3 rounded-xl font-medium [@media(hover:hover)]:hover:shadow-lg transition-shadow duration-150 active:scale-[0.97]"
                      >
                        Go to Login
                      </button>
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="w-full bg-white/10 text-white px-6 py-2 rounded-xl font-medium [@media(hover:hover)]:hover:bg-white/20 transition-colors duration-150 active:scale-[0.97]"
                      >
                        Try Again
                      </button>
                    </>
