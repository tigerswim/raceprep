...
const TrainingScreenContent = React.memo(function TrainingScreenContent() {
                      ...
                      >
                        <span className="text-lg">
                          {workout.discipline === "swim" ? (
                            ...
                            <TbBike className="w-4 h-4 text-green-400" />
                          ) : workout.discipline === "run" ? (
                            <TbRun className="w-4 h-4 text-orange-400" />
                          ) : (
  ...
  if (hasError) {
    return (
      <div
        className="bg-slate-900 relative h-full overflow-auto flex items-center justify-center"
    ...
    >
      ...
      {showWorkoutDetail && selectedWorkout && (
        <div className="fixed inset-0 bg-black/95 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-slate-800 backdrop-blur-xl rounded-2xl border border-white/10 w-full max-w-2xl max-h-[90vh] overflow-auto shadow-2xl">
            {/* Modal Header */}
